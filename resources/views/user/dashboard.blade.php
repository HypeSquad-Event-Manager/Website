...
<section class="hero is-medium is-primary bg">
        ...
        <div class="columns is-multiline is-centered">
            @foreach (Events::all() as $event)
                ...
                <div class="box is-parent" style="max-width: 500px; min-height: 400px;">
                    <div class="content has-text-centered" style="white-space: inherit;word-break: break-word;">
    ...
    <img style="bottom: -20px; position: absolute;" class="is-fullwidth is-widescreen" src="{{ asset('img/sadwd.svg') }}" alt="">
